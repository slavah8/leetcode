<h2><a href="https://leetcode.com/problems/minimum-operations-to-make-numbers-non-positive">2729. Minimum Operations to Make Numbers Non-positive</a></h2><h3>Hard</h3><hr><p>You are given a <strong>0-indexed</strong> integer array <code>nums</code> and two integers <code>x</code> and <code>y</code>. In one operation, you must choose an index <code>i</code> such that <code>0 &lt;= i &lt; nums.length</code> and perform the following:</p>
