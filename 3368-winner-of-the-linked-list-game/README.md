<h2><a href="https://leetcode.com/problems/winner-of-the-linked-list-game">3368. Winner of the Linked List Game</a></h2><h3>Easy</h3><hr><p>You are given the <code>head</code> of a linked list of <strong>even</strong> length containing integers.</p>
