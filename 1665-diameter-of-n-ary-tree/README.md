<h2><a href="https://leetcode.com/problems/diameter-of-n-ary-tree">1665. Diameter of N-Ary Tree</a></h2><h3>Medium</h3><hr><p>Given a <code>root</code> of an <code>N-ary tree</code>, you need to compute the length of the diameter of the tree.</p>
