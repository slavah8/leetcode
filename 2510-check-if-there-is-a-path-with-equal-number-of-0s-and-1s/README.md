<h2><a href="https://leetcode.com/problems/check-if-there-is-a-path-with-equal-number-of-0s-and-1s">2653. Check if There is a Path With Equal Number of 0's And 1's</a></h2><h3>Medium</h3><hr><p>You are given a <strong>0-indexed</strong> <code>m x n</code> <strong>binary</strong> matrix <code>grid</code>. You can move from a cell <code>(row, col)</code> to any of the cells <code>(row + 1, col)</code> or <code>(row, col + 1)</code>.</p>
